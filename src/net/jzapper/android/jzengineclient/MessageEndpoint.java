 ...
 */
@Api(name = "messageEndpoint", namespace = @ApiNamespace(ownerDomain = "jzapper.net", ownerName = "jzapper.net", packagePath="android.jzengineclient"))
...
public class MessageEndpoint {
   ...
   */
  private static final String API_KEY = "AIzaSyB6i9Vuh1hJ_cFjiajMLjzVlhplL9JXKQU";
