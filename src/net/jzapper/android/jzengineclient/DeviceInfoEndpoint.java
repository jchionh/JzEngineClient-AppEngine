...
import net.jzapper.android.jzengineclient.EMF;
...
@Api(name = "deviceinfoendpoint", namespace = @ApiNamespace(ownerDomain = "jzapper.net", ownerName = "jzapper.net", packagePath = "android.jzengineclient"))
